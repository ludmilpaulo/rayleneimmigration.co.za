"""
Django settings for raylene project.
"""
import os
...
WSGI_APPLICATION = 'raylene.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'raylene.exceptions.custom_exception_handler',
}
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@rayleneimmigration.co.za')
